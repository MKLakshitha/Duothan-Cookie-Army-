...
try {
    ...
    %>
      ...
      <nav id="navbar" class="navbar">
          ...
          <li><a href="../../Cabs.jsp">Medicine</a></li>
          ...
          <li class="dropdown"><a href="../../about.jsp"><span>About Us</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
				<li><a href="../about.html">Medi Lanka</a></li>
                ...
                <nav class="sidebar-nav" >
                    <ul id="sidebarnav" >
                       <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                           ...
                           <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="adminDashboard.jsp" aria-expanded="false"><i class="mdi mdi-hospital"></i><span
                                    class="hide-menu">Available Medicine</span></a></li>
                                       
                       
						
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="Users.jsp" aria-expanded="false"><i class="mdi mdi-account-circle"></i><span
                                    class="hide-menu">Citizen</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="Staff.jsp" aria-expanded="false"><i class="mdi mdi-pharmacy"></i><span
                                    class="hide-menu">Pharmacy</span></a></li>

                                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="StaffApproved.jsp" aria-expanded="false"><i class="mdi mdi-account-settings-variant"></i><span
                                    class="hide-menu">Pharmacy Approval</span></a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        <h4 class="card-title">All Available Medicine</h4>
                                        <h5 class="card-subtitle" style="font-size:14px">Overview of Available Medicines</h5>
                                    </div>
                                    <div class="ms-auto">
                                        <div class="dl">
                                    ...
                                    <table class="table mb-0 table-hover align-middle text-nowrap" id="example">
                                        ...
                                        <%while(rs.next()){
                                            ...
                                            <tr>
                                                ...
                                                <td><div class="">
                                                            <h4 class="m-b-0 font-16"><%=rs.getString("medicine") %></h4>
                                                        </div></td>
                                                <td><%=rs.getString("company") %></td>
                                                <td><%=rs.getString("category") %></td>
                                                <td>
                                                    <label class="badge bg-success"><%=rs.getString("quantity") %></label>
                                                </td>
                                                <td><%=rs.getString("year") %></td>
                                                <td>
                                                    <h5  class="badge bg-danger" style="font-size:16px;">Rs<%=rs.getString("price") %>.00</h5>
                                                </td>
...
<div id="popup2" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Update Medicine Details</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
			<form action="../../EditFly?id=<%=rs.getString("id") %>" method="post" style="color:black; font-weight:bold;">
			    <span style="color:black; font-weight:bold;">medicine</span><br>
			    <input type="text" class="input-form" name="Airline" ><br>
			    	    <span style="color:black; font-weight:bold;">company</span><br>
			    ...
			    <input type="text" class="input-form" name="Destination" ><br>
			    			    		    <span style="color:black; font-weight:bold;">quantity</span><br>
			    <input type="text" class="input-form" name="DateTime" ><br>
			    					    		    <span style="color:black; font-weight:bold;">  Manufactured Year</span>	  <br>
			    <input type="date" class="input-form" name="Price" ><br>
...
<div id="popup1" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Enter Medicine Details</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
