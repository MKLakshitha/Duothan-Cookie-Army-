                ...
                <nav class="sidebar-nav" >
                    <ul id="sidebarnav" >
                       <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                           ...
                           <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="adminDashboard.jsp" aria-expanded="false"><i class="mdi mdi-taxi"></i><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="Staff.jsp" aria-expanded="false"><i class="mdi mdi-account-star-variant"></i><span
                                    class="hide-menu">Driver</span></a></li>
                                                                           <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        <h4 class="card-title">All Fuel Details</h4>
                                        <h5 class="card-subtitle" style="font-size:14px">Overview of Fuel Details</h5>
                                    </div>
                                    <div class="ms-auto">
                                        <div class="dl">
                                    ...
                                    <table class="table mb-0 table-hover align-middle text-nowrap" id="example">
                                        <thead>
                                            ...
                                            <th class="border-top-0">Registration No</th>
                                                ...
                                                <th class="border-top-0">Fuel Type</th>
                                                <th class="border-top-0">Liters</th>
                                                <th class="border-top-0">Date and Time</th>
                                                <th class="border-top-0">Available Liters</th>
...
<div id="popup2" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Update Fuel Details</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
			<form action="../../editBokking?id=<%=rs.getString("RegNo") %>" method="post" style="color:black; font-weight:bold;">
			    <span style="color:black; font-weight:bold;">Category</span><br>
			    <input type="text" class="input-form" name="Airline" ><br>
			    	    <span style="color:black; font-weight:bold;">Fuel Type</span><br>
			    <input type="text" class="input-form" name="Depature" ><br>
			    		    <span style="color:black; font-weight:bold;">Liters</span>	    <br>
			    <input type="text" class="input-form" name="Destination" ><br>
			    			    		    <span style="color:black; font-weight:bold;">Date & Time</span><br>
			     <input type="datetime-local" class="input-form" name="Passengers" ><br>
			    			    		    <span style="color:black; font-weight:bold;">Available</span><br>
			...
			.input-form{
			  ...
			  color:gray;
                                               ...
                                               <td ><h5 class="badge bg-primary"><%=rs.getString("RegNo") %></h5></td>
                                                <td>
                                                   
												<h3 class="badge bg-secondary"><%=rs.getString("Category") %></h3>


                                                </td>
                                                <td class="m-b-0 font-16"><%=rs.getString("FuelType") %></td>
                                                <td><%=rs.getString("Liters") %></td>
                                                <td><%=rs.getString("DateTime") %></td>
                                                <td>
                                                    <label class="badge bg-success"><%=rs.getString("Available") %></label>
                                                </td>
                                                ...
                                                <td><a href="../../DeleteBookings?id=<%=rs.getString("RegNo") %>" id=""><img src="../assets/img/icons8-delete-100.png" style="width:40px; height:40px;"></a></td>
...
<div id="popup1" class="overlay">
	<div class="popup1">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Enter Fuel Details</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
			<form action="../../StaffA" method="post" style="color:black; font-weight:bold;">
			Registration Number<br>
			    <input type="number" class="input-form1" name="MemberID" style="width:370px; margin:5px;"><br>
			    Category<br>
			    <input type="text" class="input-form1" name="FlightID" style="width:370px; margin:5px;"><br>
			   Fuel Type<br>
			    <input type="text" class="input-form1" name="Airline" style="width:370px; margin:5px;"><br>
			    			    Liters<br>
			    <input type="text" class="input-form1" name="Depature" style="width:370px; margin:5px;"><br>
			    			    Date & Time<br>
			    <input type="datetime-local" class="input-form1" name="Destination" style="width:370px; margin:5px;"><br>
			Available<br>
			    <input type="number" class="input-form1" name="DateTime" style="width:370px; margin:5px;"><br>
			     Total<br>
			    <input type="number" class="input-form1" name="Passengers" style="width:370px; margin:5px;"><br>
