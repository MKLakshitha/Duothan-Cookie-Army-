      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          try {
  		    ...
  		    sql ="Select * from citizen where memberID ='"+MemberID+"'";
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <div class="text-end upgrade-btn">
                            <a href="Staff(sp).jsp" class="btn btn-primary text-white"
                                target="_blank">Apply to be Pharmacy</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                ...
                                <h6><%= rs.getString("phone")%></h6><small class="text-muted p-t-30 db">Pharmacy Name</small>
                                <h6><%= rs.getString("pharmacy")%></h6> <small class="text-muted p-t-30 db">Address</small>
                            ...
                            <span style="color: red; font-size:12px;">${error}</span>
                                <form class="form-horizontal form-material mx-2" method="get" action="../../register">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label class="col-md-12">Pharmacy</label>
                                        <div class="col-md-12">
                                            <input type="password" placeholder="<%=rs.getString("pharmacy") %>"
