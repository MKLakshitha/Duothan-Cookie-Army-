                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        <h4 class="card-title">All Available taxi</h4>
                                        <h5 class="card-subtitle" style="font-size:14px">Overview of Available Taxi to Tour</h5>
                                    </div>
                                    <div class="ms-auto">
                                        <div class="dl">
                                    ...
                                    <table class="table mb-0 table-hover align-middle text-nowrap" id="example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Vehicle Color</th>
                                                <th class="border-top-0">Manufactured By</th>
                                                <th class="border-top-0">Manufactured Year</th>
                                        ...
                                        <%while(rs.next()){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="badge bg-success"><%=rs.getString("country") %></label>
                                                </td>

                                                <td>
                                                    <h5  class="badge bg-danger" style="font-size:16px;">$<%=rs.getString("year") %> U.S</h5>
                                                </td>
                                                <td><a href="track.jsp"><img src="../assets/img/25530.jpg" style="width:40px; height:40px;"></a></td>
...
<div id="popup2" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Update Taxi Details</h2>
		...
		<div class="content">
			<form action="../../EditFly?id=<%=rs.getString("id") %>" method="post" style="color:black; font-weight:bold;">
			    ...
			    <input type="text" class="input-form" name="Depature" ><br>
			    		    <span style="color:black; font-weight:bold;">Vehicle Color</span>	    <br>
			    <input type="text" class="input-form" name="Destination" ><br>
			    			    		    <span style="color:black; font-weight:bold;">Manufactured By</span><br>
...
<div id="popup1" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Enter Taxi Details</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
